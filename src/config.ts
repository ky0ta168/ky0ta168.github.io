...
export const siteConfig: SiteConfig = {
	...
	favicon: [
		...
		{
		  src: '/favicon/icon-light-rounded.png',    // Path of the favicon, relative to the /public directory
		...
		{
		  src: '/favicon/icon-dark-rounded.png',    // Path of the favicon, relative to the /public directory
